...
TEST_PRICING_FORMATTED = {1: {'price': 599, 'VAT': 119.8},
                          2: {'price': 250, 'VAT': 0},
                          3: {'price': 250, 'VAT': 0},
                          4: {'price': 1000, 'VAT': 0},
                          5: {'price': 1250, 'VAT': 250.0}}

TEST_VALID_GBP_ORDER = {1: {'quantity': 1, 'total_price': 599.0, 'total_VAT': 119.8},
...
def test_calc_order_details():
    assert api.calc_order_details(
        TEST_ORDER_FORMATTED, TEST_PRICING_FORMATTED, GBP
